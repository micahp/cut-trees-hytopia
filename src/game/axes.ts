...
export const AXES: Record<AxeId, AxeDef> = {
  ...
  wooden: {
    ...
    name: "Wooden Axe",
    rarity: "common",
    modelUri: "models/axes/wooden-axe.gltf",
    damage: 12,
    cooldown: 0.90,
    areaRadius: 1.7,
  },
  ...
  stone: {
    ...
    name: "Stone Axe",
    rarity: "rare",
    modelUri: "models/axes/stone-axe.gltf",
    damage: 20,
    cooldown: 0.85,
    areaRadius: 2.0,
  },
  ...
  iron: {
    ...
    name: "Iron Axe",
    rarity: "epic",
    modelUri: "models/axes/iron-axe.gltf",
    damage: 35,
    cooldown: 0.80,
    areaRadius: 2.6,
  },
  golden: {
    ...
    name: "Golden Axe",
    rarity: "epic",
    modelUri: "models/axes/golden-axe.gltf",
    damage: 28,
  ...
  diamond: {
    ...
    name: "Diamond Axe",
    rarity: "mythic",
    modelUri: "models/axes/diamond-axe.gltf",
    damage: 55,
    cooldown: 0.65,
    areaRadius: 3.3,
  },
  ...
  ruby: {
    ...
    name: "Ruby Axe",
    rarity: "exotic",
    modelUri: "models/axes/ruby-axe.gltf",
  ...
  sapphire: {
    ...
    name: "Sapphire Axe",
    rarity: "exotic",
    modelUri: "models/axes/sapphire-axe.gltf",
    damage: 60,
    cooldown: 0.70,
  ...
  emerald: {
    ...
    name: "Emerald Axe",
    rarity: "exotic",
    modelUri: "models/axes/emerald-axe.gltf",
    damage: 60,
    cooldown: 0.65,
    areaRadius: 3.3,
    perks: {
